...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalog', '0027_auto_20200814_1357'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tn_parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='catalog.CategoryTest', verbose_name='Parent')),
            ],
            options={
